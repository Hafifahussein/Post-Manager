// GitHub Pages compatible version - replaces JSON Server with localStorage
...
// Replace the original BASE_URL with mock fetch functionality
const BASE_URL = '/posts'; // This will be intercepted by mockFetch

// Override fetch for this application
