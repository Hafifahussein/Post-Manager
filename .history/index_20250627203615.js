...
// Function to fetch and initialize data from db.json
async function initializeData() {
  try {
    ...
    if (!localStorage.getItem('blogPosts')) {
      ...
      // Initialize localStorage with the data from db.json
      localStorage.setItem('blogPosts', JSON.stringify(dbData.posts || []));
    }
  } catch (error) {
    console.error('Error initializing data:', error);
    // Fallback to empty array if db.json can't be loaded
